...
router.put('/users/userAndUpload',  auth.validateToken,auth.ValidateAdmin, usersController.updateUserAndUploadPic)
router.get('/users' ,auth.validateToken,auth.ValidateAdmin, usersController.findAll)
...
router.post('/users/login' ,auth.validateTokenPublic, loginLogoutController.logIn)
...
router.get('/users/isLoggedIn' ,auth.validateToken, auth.getIsloggedIn)
router.get('/users/role' , auth.validateToken,auth.getRole)
// router.put('/users/changeIsLoggedIn' , auth.validateToken,auth.changeIsloggeIn)
router.get('/users/username' ,auth.validateToken,auth.getUserName)
