...
router.put('/users/userAndUpload', upload.uploadFile , auth.validateToken, usersController.updateUserAndUploadPic)
router.get('/users' , usersController.findAll)
router.delete('/users/delete/:id' ,auth.validateToken, usersController.delete)
